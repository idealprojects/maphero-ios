...
[![SPM compatible](https://img.shields.io/badge/Swift%20Package%20Manager-compatible-FA7343.svg?style=flat&logo=Swift)](https://swiftpackageindex.com/maplibre/maphero-ios-distribution)

> **Note**  
> This repository only exists for the purpose of binary distribution of MapHero Native for iOS on the Swift Package Index.
> Please use the [main MapHero Native repository](https://github.com/idealprojects/maphero-native) to report issues or ask for help.

[MapHero Native](https://github.com/idealprojects/maphero-native) is a community-led fork derived from [mapbox-gl-native](https://github.com/mapbox/mapbox-gl-native) before their switch to a non-OSS license. The fork also includes Maps SDK for iOS and macOS (forked from [mapbox-gl-native-ios](https://github.com/mapbox/mapbox-gl-native-ios)) and Android SDK (forked from [mapbox-gl-native-android](https://github.com/mapbox/mapbox-gl-native-android)).

---

## Add MapHero to your Project
...
You can override the MapHero package dependency and edit its content by adding it as a local package.  See [Editing a Package Dependency as a Local Package](https://developer.apple.com/documentation/swift_packages/editing_a_package_dependency_as_a_local_package).
...
## Test MapHero with a Swift Playgrounds
...
* See issue [maphero-ios-distribution#8](https://github.com/idealprojects/maphero-ios/issues/8) for screenshots of the MapHero for Swift Playgrounds in action.
